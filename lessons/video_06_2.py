...
# См Метод check_value - присвоили Приватный Статус декоратором из библиотеки.
...
pt.check_value(55) # Выдает Ошибку Использования // Point.check_value() is inaccessible due to its protection level